...
@dataclass
class NetworkManagementApiActivateDeviceOutput:
    class Meta:
        name = "Envelope"
        namespace = "http://schemas.xmlsoap.org/soap/envelope/"

    body: Optional["NetworkManagementApiActivateDeviceOutput.Body"] = field(
        default=None,
        metadata={
            "name": "Body",
            "type": "Element",
    ...
    class Body:
        ...
        fault: Optional["NetworkManagementApiActivateDeviceOutput.Body.Fault"] = field(
            default=None,
            metadata={
                "name": "Fault",
                "type": "Element",
        ...
        class Fault:
            ...
            detail: Optional["NetworkManagementApiActivateDeviceOutput.Body.Fault.Detail"] = field(
                default=None,
                metadata={
                    "type": "Element",
                    "namespace": "",
